...
This repository contains the ChestTBDetection OpenMRS Open Web App.
...
This will create a file called `chesttbdetection.zip` file in the `dist` directory,
...
This will build and deploy the app to the `D:\UoL\Opemrs\referenceapplication-standalone-2.12.2\tb_web_app`
...
```js
{
  "LOCAL_OWA_FOLDER": "D:\UoL\Opemrs\referenceapplication-standalone-2.12.2\tb_web_app"
}
```
...
{
  "LOCAL_OWA_FOLDER": "D:\UoL\Opemrs\referenceapplication-standalone-2.12.2\tb_web_app",
  "APP_ENTRY_POINT": "http://localhost:8081/openmrs-standalone/owa/chesttbdetection/index.html"
}
```
