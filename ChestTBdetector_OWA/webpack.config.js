 ...
 */
// generated on 2023-07-10 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'chesttbdetection';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8081/openmrs-standalone/owa/app/templates/patientSearch.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/chesttbdetection`,
	  css: `${__dirname}/app/css/chesttbdetection.css`,
	  vendor : [
